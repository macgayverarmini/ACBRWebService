...
const
  // Chave de acesso real do CTe de subcontratação
  TEST_CTE_ACCESS_KEY = '00000000000000000000000000000000000000000000';
  TEST_NFE_ACCESS_KEY = '00000000000000000000000000000000000000000000';
  // Arquivos XML de teste
  TEST_CTE_XML_FILE = 'cteTestData.xml';
  TEST_NFE_XML_FILE = 'nfeTestData.xml';
