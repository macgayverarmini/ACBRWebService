...
begin
  ...
  AStream.Position := 0;
  // Optimize: Read directly into native string to avoid intermediate TBytes allocation
...
var
  EncStr: string;
begin
  // Optimize: Avoid intermediate TBytes conversion and evaluate EncodeStringBase64 once
