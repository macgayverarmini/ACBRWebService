...
var
  strBase64: string;
begin
  // ⚡ Bolt: Read directly into native string buffer, avoiding intermediate TBytes allocation and GetString conversion
...
begin
  ...
  // ⚡ Bolt: Cache base64 result to avoid redundant function evaluation and remove TBytes conversion roundtrips
